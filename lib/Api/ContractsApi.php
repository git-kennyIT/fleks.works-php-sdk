...
class ContractsApi
{
     ...
     * @param  bool $employees get all contracts for the Employees (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function v1ContractsGet($limit, $page, $employees)
    {
        $this->v1ContractsGetWithHttpInfo($limit, $page, $employees);
    }

    /**
     * Operation v1ContractsGetWithHttpInfo
     *
     * Get all the contracts
     *
     * @param  float $limit Amount of the returned results per page (max &#x3D; 1000) (required)
     ...
     */
    public function v1ContractsGetWithHttpInfo($limit, $page, $employees)
    {
        $request = $this->v1ContractsGetRequest($limit, $page, $employees);
     ...
     */
    public function v1ContractsGetAsync($limit, $page, $employees)
    {
        return $this->v1ContractsGetAsyncWithHttpInfo($limit, $page, $employees)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v1ContractsGetAsyncWithHttpInfo
     *
     * Get all the contracts
     *
     * @param  float $limit Amount of the returned results per page (max &#x3D; 1000) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v1ContractsGetAsyncWithHttpInfo($limit, $page, $employees)
    {
        $returnType = '';
        $request = $this->v1ContractsGetRequest($limit, $page, $employees);
    ...
    /**
     * Create request for operation 'v1ContractsGet'
     *
     * @param  float $limit Amount of the returned results per page (max &#x3D; 1000) (required)
     * @param  float $page The returned page (will be based on the limit that is set) (required)
     * @param  bool $employees get all contracts for the Employees (required)
     ...
     */
    public function v1ContractsGetRequest($limit, $page, $employees)
    {

        // verify the required parameter 'limit' is set
        if ($limit === null || (is_array($limit) && count($limit) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $limit when calling v1ContractsGet'
            );
        }
        ...
        if ($page === null || (is_array($page) && count($page) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $page when calling v1ContractsGet'
            );
        }
        ...
        if ($employees === null || (is_array($employees) && count($employees) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $employees when calling v1ContractsGet'
            );
        }
