...
class JobsApi
{
     ...
     * @return void
     */
    public function v1JobsGet($limit, $page)
    {
        $this->v1JobsGetWithHttpInfo($limit, $page);
    }

    /**
     * Operation v1JobsGetWithHttpInfo
     *
     * Get all the jobs
     *
     * @param  float $limit Amount of the returned results per page (max &#x3D; 1000) (required)
     ...
     */
    public function v1JobsGetWithHttpInfo($limit, $page)
    {
        $request = $this->v1JobsGetRequest($limit, $page);
     ...
     */
    public function v1JobsGetAsync($limit, $page)
    {
        return $this->v1JobsGetAsyncWithHttpInfo($limit, $page)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v1JobsGetAsyncWithHttpInfo
     *
     * Get all the jobs
     *
     * @param  float $limit Amount of the returned results per page (max &#x3D; 1000) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v1JobsGetAsyncWithHttpInfo($limit, $page)
    {
        $returnType = '';
        $request = $this->v1JobsGetRequest($limit, $page);
    ...
    /**
     * Create request for operation 'v1JobsGet'
     *
     * @param  float $limit Amount of the returned results per page (max &#x3D; 1000) (required)
     * @param  float $page The returned page (will be based on the limit that is set) (required)
     *
     ...
     */
    public function v1JobsGetRequest($limit, $page)
    {

        // verify the required parameter 'limit' is set
        if ($limit === null || (is_array($limit) && count($limit) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $limit when calling v1JobsGet'
            );
        }
        ...
        if ($page === null || (is_array($page) && count($page) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $page when calling v1JobsGet'
            );
        }
