...
class ShiftsApi
{
     ...
     * @param  string $start_date Set the start date for the range (YYYY-MM-DD) (optional)
     * @param  string $end_date Set the end date for the range (YYYY-MM-DD) (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function v1ShiftsGet($limit, $page, $start_date = null, $end_date = null)
    {
        $this->v1ShiftsGetWithHttpInfo($limit, $page, $start_date, $end_date);
    }

    /**
     * Operation v1ShiftsGetWithHttpInfo
     *
     * Get all the Shifts
     *
     * @param  float $limit Amount of the returned results per page (max &#x3D; 1000) (required)
     ...
     */
    public function v1ShiftsGetWithHttpInfo($limit, $page, $start_date = null, $end_date = null)
    {
        $request = $this->v1ShiftsGetRequest($limit, $page, $start_date, $end_date);
     ...
     */
    public function v1ShiftsGetAsync($limit, $page, $start_date = null, $end_date = null)
    {
        return $this->v1ShiftsGetAsyncWithHttpInfo($limit, $page, $start_date, $end_date)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v1ShiftsGetAsyncWithHttpInfo
     *
     * Get all the Shifts
     *
     * @param  float $limit Amount of the returned results per page (max &#x3D; 1000) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v1ShiftsGetAsyncWithHttpInfo($limit, $page, $start_date = null, $end_date = null)
    {
        $returnType = '';
        $request = $this->v1ShiftsGetRequest($limit, $page, $start_date, $end_date);
    ...
    /**
     * Create request for operation 'v1ShiftsGet'
     *
     * @param  float $limit Amount of the returned results per page (max &#x3D; 1000) (required)
     * @param  float $page The returned page (will be based on the limit that is set) (required)
     * @param  string $start_date Set the start date for the range (YYYY-MM-DD) (optional)
     ...
     */
    public function v1ShiftsGetRequest($limit, $page, $start_date = null, $end_date = null)
    {

        // verify the required parameter 'limit' is set
        if ($limit === null || (is_array($limit) && count($limit) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $limit when calling v1ShiftsGet'
            );
        }
        ...
        if ($page === null || (is_array($page) && count($page) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $page when calling v1ShiftsGet'
            );
        }



        $resourcePath = '/v1/shifts/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
