...
class UsersApi
{
     ...
     * @return void
     */
    public function v1UsersGet($limit, $page)
    {
        $this->v1UsersGetWithHttpInfo($limit, $page);
    }
     ...
     */
    public function v1UsersGetWithHttpInfo($limit, $page)
    {
        $request = $this->v1UsersGetRequest($limit, $page);
     ...
     */
    public function v1UsersGetAsync($limit, $page)
    {
        return $this->v1UsersGetAsyncWithHttpInfo($limit, $page)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v1UsersGetAsyncWithHttpInfo($limit, $page)
    {
        $returnType = '';
        $request = $this->v1UsersGetRequest($limit, $page);
     ...
     */
    public function v1UsersGetRequest($limit, $page)
    {

        // verify the required parameter 'limit' is set
        if ($limit === null || (is_array($limit) && count($limit) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $limit when calling v1UsersGet'
            );
        }
        ...
        if ($page === null || (is_array($page) && count($page) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $page when calling v1UsersGet'
            );
        }
