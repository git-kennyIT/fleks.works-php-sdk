...
class ProjectsApi
{
     ...
     * @return void
     */
    public function v1ProjectsGet($limit, $page)
    {
        $this->v1ProjectsGetWithHttpInfo($limit, $page);
    }

    /**
     * Operation v1ProjectsGetWithHttpInfo
     *
     * Get all the projects
     *
     * @param  float $limit Amount of the returned results per page (max &#x3D; 1000) (required)
     ...
     */
    public function v1ProjectsGetWithHttpInfo($limit, $page)
    {
        $request = $this->v1ProjectsGetRequest($limit, $page);
     ...
     */
    public function v1ProjectsGetAsync($limit, $page)
    {
        return $this->v1ProjectsGetAsyncWithHttpInfo($limit, $page)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v1ProjectsGetAsyncWithHttpInfo
     *
     * Get all the projects
     *
     * @param  float $limit Amount of the returned results per page (max &#x3D; 1000) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v1ProjectsGetAsyncWithHttpInfo($limit, $page)
    {
        $returnType = '';
        $request = $this->v1ProjectsGetRequest($limit, $page);
    ...
    /**
     * Create request for operation 'v1ProjectsGet'
     *
     * @param  float $limit Amount of the returned results per page (max &#x3D; 1000) (required)
     * @param  float $page The returned page (will be based on the limit that is set) (required)
     *
     ...
     */
    public function v1ProjectsGetRequest($limit, $page)
    {

        // verify the required parameter 'limit' is set
        if ($limit === null || (is_array($limit) && count($limit) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $limit when calling v1ProjectsGet'
            );
        }
        ...
        if ($page === null || (is_array($page) && count($page) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $page when calling v1ProjectsGet'
            );
        }
