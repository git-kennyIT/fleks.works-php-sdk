...
/**
 * JobCategoriesApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class JobCategoriesApi
{
     ...
     * @return void
     */
    public function v1JobCategoriesGet($limit, $page)
    {
        $this->v1JobCategoriesGetWithHttpInfo($limit, $page);
    }

    /**
     * Operation v1JobCategoriesGetWithHttpInfo
     *
     * Get all the categories
     *
     * @param  float $limit Amount of the returned results per page (max &#x3D; 1000) (required)
     ...
     */
    public function v1JobCategoriesGetWithHttpInfo($limit, $page)
    {
        $request = $this->v1JobCategoriesGetRequest($limit, $page);
    ...
    /**
     * Operation v1JobCategoriesGetAsync
     *
     * Get all the categories
     *
     * @param  float $limit Amount of the returned results per page (max &#x3D; 1000) (required)
     ...
     */
    public function v1JobCategoriesGetAsync($limit, $page)
    {
        return $this->v1JobCategoriesGetAsyncWithHttpInfo($limit, $page)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v1JobCategoriesGetAsyncWithHttpInfo
     *
     * Get all the categories
     *
     * @param  float $limit Amount of the returned results per page (max &#x3D; 1000) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v1JobCategoriesGetAsyncWithHttpInfo($limit, $page)
    {
        $returnType = '';
        $request = $this->v1JobCategoriesGetRequest($limit, $page);
    ...
    /**
     * Create request for operation 'v1JobCategoriesGet'
     *
     * @param  float $limit Amount of the returned results per page (max &#x3D; 1000) (required)
     * @param  float $page The returned page (will be based on the limit that is set) (required)
     *
     ...
     */
    public function v1JobCategoriesGetRequest($limit, $page)
    {

        // verify the required parameter 'limit' is set
        if ($limit === null || (is_array($limit) && count($limit) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $limit when calling v1JobCategoriesGet'
            );
        }
        ...
        if ($page === null || (is_array($page) && count($page) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $page when calling v1JobCategoriesGet'
            );
        }

        $resourcePath = '/v1/job-categories/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
