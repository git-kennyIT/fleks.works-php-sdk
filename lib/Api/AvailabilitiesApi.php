...
class AvailabilitiesApi
{
     ...
     * @return void
     */
    public function v1AvailabilitiesGet($limit, $page)
    {
        $this->v1AvailabilitiesGetWithHttpInfo($limit, $page);
    }

    /**
     * Operation v1AvailabilitiesGetWithHttpInfo
     *
     * Get all the availabilities
     *
     * @param  float $limit Amount of the returned results per page (max &#x3D; 1000) (required)
     ...
     */
    public function v1AvailabilitiesGetWithHttpInfo($limit, $page)
    {
        $request = $this->v1AvailabilitiesGetRequest($limit, $page);
    ...
    /**
     * Operation v1AvailabilitiesGetAsync
     *
     * Get all the availabilities
     *
     * @param  float $limit Amount of the returned results per page (max &#x3D; 1000) (required)
     ...
     */
    public function v1AvailabilitiesGetAsync($limit, $page)
    {
        return $this->v1AvailabilitiesGetAsyncWithHttpInfo($limit, $page)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v1AvailabilitiesGetAsyncWithHttpInfo
     *
     * Get all the availabilities
     *
     * @param  float $limit Amount of the returned results per page (max &#x3D; 1000) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v1AvailabilitiesGetAsyncWithHttpInfo($limit, $page)
    {
        $returnType = '';
        $request = $this->v1AvailabilitiesGetRequest($limit, $page);
    ...
    /**
     * Create request for operation 'v1AvailabilitiesGet'
     *
     * @param  float $limit Amount of the returned results per page (max &#x3D; 1000) (required)
     * @param  float $page The returned page (will be based on the limit that is set) (required)
     *
     ...
     */
    public function v1AvailabilitiesGetRequest($limit, $page)
    {

        // verify the required parameter 'limit' is set
        if ($limit === null || (is_array($limit) && count($limit) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $limit when calling v1AvailabilitiesGet'
            );
        }
        ...
        if ($page === null || (is_array($page) && count($page) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $page when calling v1AvailabilitiesGet'
            );
        }

        $resourcePath = '/v1/availabilities/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
