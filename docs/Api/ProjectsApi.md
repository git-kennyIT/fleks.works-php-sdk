...
| ------------- | ------------- | ------------- |
| [**v1ProjectsGet()**](ProjectsApi.md#v1ProjectsGet) | **GET** /v1/projects/ | Get all the projects |


## `v1ProjectsGet()`

```php
v1ProjectsGet($limit, $page)
```
...
try {
    $apiInstance->v1ProjectsGet($limit, $page);
} catch (Exception $e) {
    echo 'Exception when calling ProjectsApi->v1ProjectsGet: ', $e->getMessage(), PHP_EOL;
}
```
