...
| ------------- | ------------- | ------------- |
| [**v1ClientsGet()**](ClientsApi.md#v1ClientsGet) | **GET** /v1/clients/ | Get all the clients |


## `v1ClientsGet()`

```php
v1ClientsGet($limit, $page)
```
...
try {
    $apiInstance->v1ClientsGet($limit, $page);
} catch (Exception $e) {
    echo 'Exception when calling ClientsApi->v1ClientsGet: ', $e->getMessage(), PHP_EOL;
}
```
